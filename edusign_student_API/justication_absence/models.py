...
class Justification(models.Model):
    ...
    date_debut = models.DateTimeField(null=False, verbose_name='start_absence_justified_date')
    date_fin = models.DateTimeField(null=False, verbose_name='end_absence_justified_date')
